...
export default function Testimonials() {
  return (
    <section className="py-20 px-8 bg-[linear-gradient(135deg,var(--color-cream)_0%,#F0DEB4_50%,var(--color-cream)_100%)]">
      ...
      <p className="font-terminal text-[0.85rem] tracking-[0.15em] text-rust text-center mb-12 uppercase">
        * The following testimonials were obtained under duress
      </p>

      <div className="flex gap-8 overflow-x-auto py-6 px-4 snap-x snap-mandatory scroll-smooth hide-scrollbar">
        {testimonials.map((t) => (
          <div
            key={t.name}
